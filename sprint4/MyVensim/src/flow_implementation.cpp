...
BaseFlow::BaseFlow() {}
BaseFlow::BaseFlow(System *origin, System *destination): origin(origin), destination(destination) {}
BaseFlow::~BaseFlow() {}
...
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
BaseFlow::BaseFlow(const BaseFlow& flow){
...
///     BaseSystem *system2 = new BaseSystem("S2", 10);
///     BaseFlow *flow1 = new BaseFlow(system1, system2);
///     BaseFlow *flow2 = new BaseFlow();
///     flow2 = flow1;
/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
BaseFlow& BaseFlow::operator=(const BaseFlow& flow){
