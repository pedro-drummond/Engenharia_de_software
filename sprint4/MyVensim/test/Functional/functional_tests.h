...
void exponential_funcional_test(){
    ...
    Model *model = new BaseModel("Modelo");
    System *system1 = new BaseSystem("S1", 100);
    System *system2 = new BaseSystem("S2", 0);
...
void exponential_system_funcional_test(){
    ...
    Model *model = new BaseModel("Modelo");
    System *q1 = new BaseSystem("q1", 100);
    System *q2 = new BaseSystem("q2", 0);
    System *q3 = new BaseSystem("q3", 100);
    System *q4 = new BaseSystem("q4", 0);
    System *q5 = new BaseSystem("q5", 0);
    Exp *f = new Exp(q1, q2);
    Exp *g = new Exp(q1,q3);
    Exp *u = new Exp(q3,q4);
    Exp *v = new Exp(q4,q1);
